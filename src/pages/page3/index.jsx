import './Section3.css'
// import Frigate from '../../assets/Frigate'
    ...
    <div id="section3">
      ...
      <div className="mainBloc">
        <div className="code_screen">
          <h2>
            <strong>{'>>'} </strong>man StanislasPielucha
          </h2>
          <h3>Software Developer Apprentice at Naval Group.</h3>
          <div>
            <h2>
              <strong>{'>>'}</strong> man Naval Group
            </h2>
            <h3>
              The company that builds warships and submarines for the french
              navy and several foreign navies.
            </h3>
          </div>
          <h2>
            <strong>{'>>'}</strong> when StanislasPielucha NavalGroup
          </h2>
          <h3>From October 2019 to April 2022.</h3>
          <h2>
            <strong>{'>>'}</strong> what mission StanislasPielucha
          </h2>
          <h3>
            The development of a software for the optimization of
            electromagnetic fields on frigates.
          </h3>
          <h2>
            <strong>{'>>'}</strong> which Technologies --used
          </h2>
          <h3>Pascal Object</h3>
          <h3>Matlab</h3>
