    ...
    return(
        <div id="section2">
            ...
            <div className="chronoligne">
                ...
                <div className="big_circle" style={{left: "156.4vh"}}></div>
                <div className="big_circle ombre_bc_abs" style={{left: "156.4vh"}}></div>
                {
                  //Dates
                }
                <h2 className="dates" style={{left:"6vh"}}>2017</h2>
                <h2 className="dates" style={{left:"81.2vh"}}>2019</h2>
                <h2 className="dates" style={{left:"152.4vh"}}>2021</h2>
                <h2 className="dates" style={{left:"197vh"}}>2022</h2>
            </div>
